...
class Stage extends FlxGroup
{
	...
	{
		var path:String = 'images/backgrounds/_scripts/$stage.hxc';
		...
		/* WORK IN PROGRESS!
		newScript.set("curStage", curStage);
		newScript.set("gfVersion", gfVersion);
		newScript.set("defaultCamZoom", PlayState.defaultCamZoom);
		*/
