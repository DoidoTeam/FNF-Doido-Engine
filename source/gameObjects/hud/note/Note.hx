...
class Note extends FlxSprite
{
	...
	public function reloadNote(songTime:Float, noteData:Int, ?noteType:String = "default"):Note
	{
		...
		switch(noteType)
		{
			default:
				noteSize = 0.7;
				frames = Paths.getSparrowAtlas("notes/default/notes");
	...
	{
		visible = active = alive = (Math.abs(songTime - Conductor.songPos) < Conductor.crochet * 4);
